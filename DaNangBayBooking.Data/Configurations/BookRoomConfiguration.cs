...
namespace DaNangBayBooking.Data.Configurations
{
    public class BookRoomConfiguration : IEntityTypeConfiguration<BookRoom>
    {
        public void Configure(EntityTypeBuilder<BookRoom> builder)
        {
            ...
            builder.Property(x => x.CheckInName).HasMaxLength(200);
            builder.Property(x => x.CheckInMail).HasMaxLength(200);
            builder.Property(x => x.CheckInIdentityCard).HasMaxLength(200);
            builder.Property(x => x.CheckInNote).HasMaxLength(200);
            builder.Property(x => x.CheckInPhoneNumber).HasMaxLength(200);
